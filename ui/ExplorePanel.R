                  ...
                  fluidRow(
                    column(6,
                           selectInput("study", h5("Select Study"),  # allow user to select study
                                       choices = list("GSE164416", "GSE115601", "GSE175988"),
                                       selected="GSE164416")),
                    column(6,
           ...
           column(6,
                  tabsetPanel(
                    ...
                    tabPanel("GO Analysis", h3("Gene Ontology Analysis"),
                             helpText("Perform Gene Ontology overepresentation test using clusterProfiler. Shows 15 top results (it takes a minute to load)."),
                             ...
                             fluidRow(
                               ...
                               column(6,
                                      selectInput("terms", h5("Select Gene Ontolgy Category"),
                                                  choices = list("Biological Processes", "Molecular Functions", "Cellular Components")))
